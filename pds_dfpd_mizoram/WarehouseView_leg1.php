    ...
    <!-- START SCRIPTS -->
		...
		document.getElementById('downloadCSV').addEventListener('click', async function() {
			try {
				...
				const csvResponse = await fetch('api/DownloadOptimalDataWarehouseLeg1.php?format=csv&tableName='+tableName+'&tableName1='+tableName1);
		...
		document.getElementById('downloadXLSX').addEventListener('click', async function() {
			try {
				var tableName = '<?php echo $tablename ?>';
				var tableName1 = '<?php echo $tablename1 ?>';
				const excelResponse = await fetch('api/DownloadOptimalDataWarehouseLeg1.php?format=xlsx&tableName='+tableName+'&tableName1='+tableName1);
