...
<style>
	...
	document.getElementById('downloadPDF').addEventListener('click', async function() {
			try {
				...
				const csvBlob = await csvResponse.blob();
				downloadFile(csvBlob, 'RolloutPlan__' + getDateString() + '.pdf');
			} catch (error) {
			...
			$.ajax({
				...
				success: function(result){
					...
					try{
						...
						var headers = ["Scenario", "WH_Used", "FPS_Used", "Total_Allocation", "Total_QKM", "Average Distance(Km)"];
	...
	$.ajax({
		...
		success: function(result){
			try{
				...
				var resultString = "Optimised Data for Applicable Year <b>" + year + "</b>, Applicable for Applicable month <b>" + applicable + "</b>. Last updated at <b>" + lastUpdated + "</b>";
