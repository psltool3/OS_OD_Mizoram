...
<script>
	const CG_JOB_KEY = 'cg_job_home_leg1';
	const JOB_ENDPOINT = '/processFileleg1';
	...
	function generateoptimisedplan() {
		const formData = new FormData();
...
function downloadExcelFile() {
    ...
    a.href = url;
    a.download = 'Template_SCO_IntraState_Mizoram.xlsx';
    a.click();
...
function downloadFile(fileType) {
    ...
    if (fileType === 'xlsx') {
        filePath = 'template/Template_SCO_IntraState_Mizoram.xlsx';
        fileName = 'Template_SCO_IntraState_Mizoram.xlsx';
    } else if (fileType === 'pdf') {
        filePath = 'template/Template_SCO_IntraState_Mizoram.pdf';
        fileName = 'Template_SCO_IntraState_Mizoram.pdf';
    }
