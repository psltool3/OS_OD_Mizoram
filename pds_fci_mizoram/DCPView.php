                                    ...
                                    <table id="export_table" class="table datatable">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:16px">Rice Procurement</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
    ...
    <!-- START SCRIPTS -->
		...
		document.getElementById('downloadCSV').addEventListener('click', async function() {
			try {
				...
				downloadFile(csvBlob, 'Bihar_Mill_' + getDateString() + '.csv');
			} catch (error) {
		...
		document.getElementById('downloadXLSX').addEventListener('click', async function() {
			try {
				...
				downloadFile(excelBlob, 'Bihar_Mill_' + getDateString() + '.xlsx');
			} catch (error) {
		...
		document.getElementById('downloadPDF').addEventListener('click', async function() {
			try {
				...
				link.href = url;
				link.download = 'Bihar_FPS_' + getDateString() + '.pdf';
				link.click();
